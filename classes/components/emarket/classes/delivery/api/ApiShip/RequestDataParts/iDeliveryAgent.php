...
interface iDeliveryAgent {
	...
	/**
	 * Возращает ФИО контактного лица
	 * @return string
	 */
	...
	/**
	 * Возращает телефон контактного лица
	 * @return string
	 */
	...
	/**
	 * Возращает почтовый ящик контакного лица
	 * @return string
	 */
