...
interface iOrder {
	...
	/**
	 * Возращает идентификатор типа доставки
	 * @return int
	 */
	...
	/**
	 * Возращает идентификатор тарифа
	 * @return int
	 */
	...
	/**
	 * Возращает дату отгрузки в определенном формате
	...
	/**
	 * Возращает идентификатор точки приема товара
	 * @return int
	 */
	...
	/**
	 * Возращает идентификатор точки выдачи товара
	 * @return int
	 */
