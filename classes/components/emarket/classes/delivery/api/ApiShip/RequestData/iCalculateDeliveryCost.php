...
interface iCalculateDeliveryCost {
	...
	/**
	 * Возращает ширину заказа
	 * @return float
	 */
	public function getWidth();
	/**
	 * Устаналивает высоту заказа
	 * @param float $height высота
	 * @return iCalculateDeliveryCost
	 */
	public function setHeight($height);
	/**
	 * Возращает высоту заказа
	 * @return float
	 */
	...
	/**
	 * Возращает оценочную стоимость заказа
	 * @return float
	 */
	...
	/**
	 * Возращает поддерживаемые типы отгрузки
	 * @return array
	 */
	...
	/**
	 * Возращает поддерживаемые типы доставки
	 * @return array
	 */
	...
	/**
	 * Возращает идентификаторы поддерживаемых провайдеров
	 * @return array
	 */
