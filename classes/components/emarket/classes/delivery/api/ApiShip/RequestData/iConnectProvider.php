...
use UmiCms\Classes\Components\Emarket\Delivery\ApiShip\iProvidersFactory;
/**
...
interface iConnectProvider {
	...
	/**
	 * Возращает идентификатор подключаемого провайдера
	 * @return string
	 */
	...
	/**
	 * Возращает подключаемого провайдера
