		...
		public function create() {
			...
			if (getRequest('param1') == 'do') {
				...
				if (!$object->isFilled()) {
					...
					$currentLanguageId = $cmsController->getCurrentLang()
						->getId();
					$object->setValue('lang_id', $currentLanguageId);
					$currentDomainId = $cmsController->getCurrentDomain()
						->getId();
					$object->setValue('domain_id', $currentDomainId);
					$object->commit();
				}
