function selections(targetWindow, container) {
	...
	*/
	...
	this.expand = jQuery.browser.msie ? function (start) {
	...
	this.getNode = jQuery.browser.msie ? function (start, ignoreNullSelection) {
	...
	*/
	this.surround = jQuery.browser.msie ? function (tag, attrs) {
	...
	/**
		...
		* @param attr Hash атрибуты тега
	*/
	this.insert = jQuery.browser.msie ? function (tag, attrs, innerHTML) {
	...
	/**
		...
		* @return Boolean
	*/
	this.isSomethingSelected = jQuery.browser.msie ? function (disableNodeCheck) {
