...
<select name="options[%name%]" label="%title%" id="" class="js-select-%name% option--field">
    <option value="0">Выберите %title%</option>
    %items%
</select>
END;
...
<option name="option[%name%]" value="%object_id%">%value%</option>
END;
